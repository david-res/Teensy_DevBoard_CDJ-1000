...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (125U * 1024U)          /*[bytes]*/

    //LV_ATTRIBUTE_LARGE_RAM_ARRAY defines where this lives, eg EXTMEM. Need 145U min
    /*Compiler prefix for a big array declaration in RAM*/
    #define LV_ATTRIBUTE_LARGE_RAM_ARRAY //__attribute__((section(".externalram"))) //This only seems to be used for LV_MEM_SIZE array
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        *Caching has LV_DRAW_SW_SHADOW_CACHE_SIZE^2 RAM cost*/
        #define LV_DRAW_SW_SHADOW_CACHE_SIZE 100
...
#define LV_CACHE_DEF_SIZE       20 * 1024
...
#define LV_ATTRIBUTE_TICK_INC __attribute__ ((section(".fastrun") ))

/*Define a custom attribute to `lv_timer_handler` function*/
#define LV_ATTRIBUTE_TIMER_HANDLER __attribute__ ((section(".fastrun") ))

/*Define a custom attribute to `lv_display_flush_ready` function*/
#define LV_ATTRIBUTE_FLUSH_READY __attribute__ ((section(".fastrun") ))
...
#define LV_ATTRIBUTE_FAST_MEM __attribute__ ((section(".fastrun")))  //TODO takes a lot of ITCM
...
#define LV_TXT_BREAK_CHARS " ,;:-" //Removed _.
...
/*1: Enable an observer pattern implementation <- required for SYSMON*/
